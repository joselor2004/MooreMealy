...
\begin{proof}
    ...
    De manière similaire, on construit le transducteur qui à $x$ associe tous les mots sauf $g(x)$. Les deux transducteurs que l'on vient
    de construire sont alors équivalents si et seulement si $g(x) = h(x)$. On a bien notre réduction
