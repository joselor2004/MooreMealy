...
\begin{proof}
    ...
    \begin{figure}[h]
        \caption{Exemple de construction de $\mathcal{M}_2$ depuis $\mathcal{M}_1$}
        \begin{center}
        Une machine de Moore $\mathcal{M}_1$ à gauche et à droite la machine de Mealy $\mathcal{M}_2$ correspondante
