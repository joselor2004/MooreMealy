...
\begin{proof}
    ...
    Si on regarde uniquement les deuxièmes éléments des couples des états, on trouve le deuxième transducteur, qui lit chaque lettre du deuxièle élément
...
reconnues par les transducteurs figure ?.
\begin{equation*}
    \begin{split}
