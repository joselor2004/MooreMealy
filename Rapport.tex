...
rationnelles. On obtient par exemple toutes les propriétés de clôture des automates finis en considérant un
transducteur comme un automate sur l'alphabet $\Sigma \times \Gamma$. Il est plus simple d'obtenir
la stabilité par composition et inverse par la vision en tant que relation.
\\~\\
