...
On peut généraliser ces définitions en s'autorisant des fonctions de transition $Q \times \Sigma^* \times \Gamma^* \longrightarrow 
\mathcal{P}(Q)$
tant qu'il n'y a qu'un nombre fini de
triplets $(q, w, v) \in Q \times \Sigma^* \times \Gamma^*$ tels que $\delta^*(q, w, v) \neq \emptyset$. En effet,
